...
<body>
    <cms:editable name='career-detail-group-legal-and-compliance-manager' label='Career Detail Page' type='richtext'>
            ...
            <div class="row mt-5">
                <div class="col-lg-8 pe-4">
                    <div class="entry-content me-sm-0 me-lg-5 pe-sm-0">
                        ...
                        <p>As a Legal &amp; Compliance Manager, you will play a critical role in ensuring that our fintech operations adhere to all legal and regulatory requirements. Your expertise will help safeguard our company against legal risks and enhance our operational efficiency through robust compliance practices.
                        </p>
                        <br/>
                        <p class="mb-2"><b>Key Responsibilities</b></p>
                        <ul>
                            <li>Manage all legal documentation and agreements for the company, ensuring compliance with current laws and regulations.</li>
                            <li>Serve as the primary liaison with external legal counsels and regulatory agencies.</li>
                            <li>Liaise with our external lawyer on loan and other legal documents to ensure accuracy and compliance.</li>
                            <li>Provide proactive legal advice to all departments on a variety of issues, including contractual obligations, intellectual property rights, and corporate governance.</li>
                            <li>Oversee the resolution of legal disputes and manage litigation processes as required.</li>
                            <li>Develop and implement standard operating procedures and guidelines to ensure compliance with regulatory requirements, particularly those related to financial services and money lending.</li>
                            <li>Monitor changes in legislation and regulation that impact the fintech and lending industries and ensure timely updates to internal policies and procedures.</li>
                            <li>Identify potential compliance issues and develop risk mitigation strategies.</li>
                            <li>Assist with customer complaints; provide guidance to the operations department before they respond to ensure all communications are compliant.</li>
                            <li>Provide guidance and support on employment-related matters, including labor law compliance and employee relations issues.</li>
                            <li>Educate and train staff on legal and compliance matters to promote a culture of compliance throughout the organization.</li>
                            <li>Advice senior management on legal and regulatory risks associated with new business initiatives, products, and markets.</li>
                            <li>Participate in strategic planning and provide legal and compliance insights to support the company’s growth and expansion.</li>
                        </ul>
                        <br/>
                        <p class="mb-2"><b>Qualifications</b></p>
                        <ul>
                            <li>Bachelor’s degree in law (LLB) or related field. A Master's degree or professional certification (e.g., CCEP, CAMS) is a plus.</li>
                            <li>Minimum of 5 years of experience in a legal and compliance role, within the financial services or fintech industry is a bonus.</li>
                            <li>In-depth knowledge of financial services regulations, money lending laws, and corporate governance.</li>
                            <li>Proven experience in managing legal documentation, agreements, and compliance programs.</li>
                            <li>Strong understanding of risk management and mitigation strategies.</li>
                            <li>Excellent communication and interpersonal skills with the ability to provide clear and concise legal advice.</li>
                            <li>Ability to work collaboratively with internal departments and external stakeholders.</li>
                            <li>Strong analytical and problem-solving skills with attention to detail.</li>
                            <li>High ethical standards and integrity.</li>
                            <li>Ability to stay updated on changes in legislation and regulatory requirements affecting the fintech industry.</li>
                        </ul>
                        ...
                        <ul class="d-flex mb-5 pb-3 gap-3 flex-wrap list-unstyled">
                            <li class="badge rounded-pill text-bg-lightgray">Legal Oversight</li>
                            <li class="badge rounded-pill text-bg-lightgray">Compliance Management</li>
                            <li class="badge rounded-pill text-bg-lightgray">Strategic Advisory</li>
                        </ul>
