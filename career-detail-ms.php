            ...
            <div class="row mt-5">
                <div class="col-lg-8 pe-4">
                    <div class="entry-content me-sm-0 me-lg-5 pe-sm-0">
                        ...
                        <h2 class="heading-single fw-semibold mt-4 pt-2 mb-4 pb-3">Mortage Specialist</h2>
                        ...
                        <p>We are seeking a proactive Mortage Specialist to be a part of our finance department. This role is pivotal in maintaining the efficiency and smooth operation of the department, ensuring that our team can focus on their primary objectives.</p>
                        <br/>
                        <p class="mb-2"><b>Key Responsibilities</b></p>
                        <ul>
                            <li>Actively listen to clients' needs, inquiries, and concerns regarding mortgage loans and refinancing.</li>
                            <li>Provide clear and detailed information on mortgage products, terms, and processes to clients.</li>
                            <li>Offer personalized mortgage solutions tailored to each client's financial situation and goals.</li>
                            <li>Maintain up-to-date knowledge of mortgage loan products, including various types of mortgages, interest rates, and eligibility criteria.</li>
                            <li>Understand the intricacies of property transactions, including legal and financial aspects.</li>
                            <li>Stay informed about industry regulations, market trends, and competitors' offerings in the mortgage advisory sector.</li>
                            <li>Utilize persuasive and consultative sales techniques to guide clients through the mortgage application process.</li>
                            <li>Meet or exceed sales targets and quotas set by the company.</li>
                            <li>Identify opportunities to cross-sell additional financial products or services to clients when appropriate.</li>
                            <li>Able to manage client expectations regarding mortgage products, processes, and timelines, ensuring transparency and satisfaction throughout the loan application and approval process.</li>
                        </ul>
                        <br/>
                        <p class="mb-2"><b>Qualifications</b></p>
                        <ul>
                            <li>Min 2 years sales experience, with experience in mortgage related business or in insurance industry will be top priority.</li>
                            <li>Fresh graduates are welcome to apply too! Training will be provided :)</li>
                            <li>Candidate must possess at least Diploma/Advanced/Higher/Graduate Diploma in any field.</li>
                            <li>23-45 years old.</li>
