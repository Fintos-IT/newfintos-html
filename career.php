...
<body>
    <cms:editable name='career' label='Career Page' type='richtext'>
        ...
        <div class="img-section">
            <div class="container">
                <div class="row mt-5 gallery-career">
                    <div class="img-container mb-4 pb-2" data-aos="fade-up"><img src="./assets/images/gallery-1.jpg" alt="thumbnail" class="img-fluid rounded-4"/></div>
                    <div class="img-container mb-4 pb-2" data-aos="fade-up" data-aos-delay="200"><img src="./assets/images/gallery-2.jpg" alt="thumbnail" class="img-fluid rounded-4"/></div>
                    <div class="img-container mb-4 pb-2" data-aos="fade-up" data-aos-delay="400"><img src="./assets/images/gallery-4.jpg" alt="thumbnail" class="img-fluid rounded-4"/></div>
                    <div class="img-container mb-4 pb-2" data-aos="fade-up" data-aos-delay="600"><img src="./assets/images/gallery-5.jpg" alt="thumbnail" class="img-fluid rounded-4"/></div>
                    <!-- <div class="img-container mb-4 pb-2" data-aos="fade-up" data-aos-delay="800"><img src="./assets/images/gallery-3.jpg" alt="thumbnail" class="img-fluid rounded-4"/></div> -->
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12 col-lg-8 square-join">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card border-0 bglightyellow rounded-4 mb-4">
                                <div class="card-body d-flex flex-column justify-content-center p-4">
                                    <div lass="icon-container" data-aos="fade-up"><img src="./assets/images/calendar-day.png" alt="join us icon"/></div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 bglightyellow rounded-4 mb-4">
                                <div class="card-body d-flex flex-column justify-content-center p-4">
                                    <div lass="icon-container" data-aos="fade-up" data-aos-delay="200"><img src="./assets/images/book-open-cover.png" alt="join us icon"/></div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card border-0 bglightyellow rounded-4 mb-4">
                                <div class="card-body d-flex flex-column justify-content-center p-4">
                                    <div lass="icon-container" data-aos="fade-up" data-aos-delay="400"><img src="./assets/images/suitcase-medical.png" alt="join us icon"/></div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 bglightyellow rounded-4 mb-4">
                                <div class="card-body d-flex flex-column justify-content-center p-4">
                                    <div lass="icon-container" data-aos="fade-up" data-aos-delay="600"><img src="./assets/images/tags.png" alt="join us icon"/></div>
        ...
        <div class="container thumbgallery-carreer">
            <div class="row my-5">
                <div class="col-md-4"><img src="./assets/images/career-img-1.jpg" alt="thumbnail" class="thumbimg img-fluid" /></div>
                <div class="col-md-4">
                    <div class="videowrap position-relative">
                        ...
                        <img src="./assets/images/career-img-2.jpg" alt="thumbnail" class="thumbimg img-fluid" />
                    </div>
                </div>
                <div class="col-md-4 "><img src="./assets/images/career-img-3.jpg" alt="thumbnail" class="thumbimg img-fluid" /></div>
            </div>
        </div>
                                        ...
                                        <div class="card-body p-0 d-flex flex-column align-items-stretch justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled d-flex flex-row gap-2 text-start">
                                                    <li>Finance</li>
                                                    <img src="./assets/images/bullets.svg" alt="bullets"/>
                                                    <li>Full time</li>
                                                </ul>
                                            </div> 
                                            <a href="career-detail-group-financial-controller.php" class="p-0 text-end"><img src="./assets/images/arrow.png" alt="view more" /></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 my-3 px-3">
                                    <div class="card card--position border-0 p-4">
                                        <div class="card-body p-0 d-flex flex-column align-items-stretch justify-content-between">
                                            ...
                                            <a href="career-detail-intern-business-it.php" class="p-0 text-end"><img src="./assets/images/arrow.png" alt="view more" /></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 my-3 px-3">
                                    <div class="card card--position border-0 p-4">
                                        <div class="card-body p-0 d-flex flex-column align-items-stretch justify-content-between">
                                            ...
                                            <a href="career-detail-group-operations-manager.php" class="p-0 text-end"><img src="./assets/images/arrow.png" alt="view more" /></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 my-3 px-3">
                                    <div class="card card--position border-0 p-4">
                                        <div class="card-body p-0 d-flex flex-column align-items-stretch justify-content-between">
                                            ...
                                            <a href="career-detail-group-legal-and-compliance-manager.php" class="p-0 text-end"><img src="./assets/images/arrow.png" alt="view more" /></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 my-3 px-3">
                                    <div class="card card--position border-0 p-4">
                                        <div class="card-body p-0 d-flex flex-column align-items-stretch justify-content-between">
                                            ...
                                            <a href="career-detail-business-development-executive.php" class="p-0 text-end"><img src="./assets/images/arrow.png" alt="view more" /></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 my-3 px-3">
                                    <div class="card card--position border-0 p-4">
                                        <div class="card-body p-0 d-flex flex-column align-items-stretch justify-content-between">
                                            ...
                                            <a href="career-detail-sales-admin-executive.php" class="p-0 text-end"><img src="./assets/images/arrow.png" alt="view more" /></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 my-3 px-3">
                                    <div class="card card--position border-0 p-4">
                                        <div class="card-body p-0 d-flex flex-column align-items-stretch justify-content-between">
                                            ...
                                            <a href="career-detail-mortgage-specialist.php" class="p-0 text-end"><img src="./assets/images/arrow.png" alt="view more" /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="ratio ratio-16x9">
                                <iframe src="./assets/videos/Video3Bella.mp4" allowfullscreen sandbox></iframe>
                            </div>
                        </div>
                    </div>
            </div>
