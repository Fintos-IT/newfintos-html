...
<body>
    <cms:editable name='career-detail-sales-admin-executive' label='Career Detail Page' type='richtext'>
            ...
            <div class="row mt-5">
                <div class="col-lg-8 pe-4">
                    <div class="entry-content me-sm-0 me-lg-5 pe-sm-0">
                        ...
                        <h2 class="heading-single fw-semibold mt-4 pt-2 mb-4 pb-3">Sales Admin Executive</h2>
                        ...
                        <p>We are seeking a highly organized and proactive Sales Admin Executive to support our sales department with a range of administrative duties. This role is pivotal in maintaining the efficiency and smooth operation of the department, ensuring that our team can focus on their primary objectives.</p>
                        <br/>
                        <p class="mb-2"><b>Key Responsibilities</b></p>
                        <ul>
                            <li>Liaise with applicants to gather necessary information for loan applications and respond to basic inquiries about the process.</li>
                            <li>Accurately input customer details into our system, evaluate data, and conduct preliminary research on potential clients' commitments and financial statements.</li>
                            <li>Efficiently update case status, ensuring a seamless transition across platforms including our internal system, Monday.com, and Microsoft Teams.</li>
                            <li>Manage document collection, ensuring all necessary paperwork is uploaded into the system promptly for further processing.</li>
                            <li>Coordinate the signing of credit loan agreements, bank loan offers, sale & purchase agreements, and other relevant documents with bankers and solicitors.</li>
                            <li>Stay informed about the property market, bank loan requirements, and our products and services to enhance customer satisfaction.</li>
                            <li>Address customer complaints in collaboration with Sales Advisors, aiming for swift and satisfactory resolutions.</li>
                            <li>Support the arrangement of site visits for prospects or customers, addressing basic questions as needed.</li>
                            <li>Maintain adherence to all company policies and government regulations throughout the administrative process.</li>
                            <li>Serve as the reception, answering calls, and recording information in the system accordingly.</li>
                        </ul>
                        <br/>
                        <p class="mb-2"><b>Qualifications</b></p>
                        <ul>
                            <li>At least 2 years of experience in a banking administrative or operational role.</li>
                            <li>Experienced in receptionist or customer service role is a plus.</li>
                            <li>Strong organizational skills and attention to detail.</li>
                            <li>Ability to speak Mandarin is essential due to the business nature.</li>
                            <li>Proficiency in Microsoft Office applications and familiarity with CRM systems.</li>
                            <li>Ability to multitask and prioritize in a fast-paced environment.</li>
                            <li>Team-oriented mindset with a positive attitude and strong problem-solving skills.</li>
                        </ul>
