                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-5">
                        <div class="hero-thumb position-relative text-center">
                            <div class="thumb-first position-absolute" data-aos="zoom-in" data-aos-duration="3000">
                                <img src="./assets/images/mortgageresult.png" alt="app" class="img-fluid"  />
                            </div>
                            <div class="thumb-second">
                                <img src="./assets/images/phonescreen.png" alt="app" class="img-fluid img-hero"  />
                            </div>    
                        </div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4 card-container open-modal" data-bs-toggle="modal" data-bs-target="#form-property-income" style="cursor: pointer;"> 
                        <div class="card border-0 text-center align-items-center justify-content-center">
                            <img src="./assets/images/property-icon.svg" alt="property income eligibility" data-aos="zoom-in" data-aos-delay="200" />
                    ...
                    <div class="col-md-4 card-container open-modal" data-bs-toggle="modal" data-bs-target="#form-property" style="cursor: pointer;">
                        <div class="card border-0 text-center align-items-center justify-content-center">
                            <img src="./assets/images/loan-icon.svg" alt="Mortgage Loan Eligibility" data-aos="zoom-in" data-aos-delay="400" />
                            <div class="card-body p-0 mt-lg-4">
                    ...
                    <div class="col-md-4 card-container open-modal" data-bs-toggle="modal" data-bs-target="#form-mortgage-refinance" style="cursor: pointer;">    
                        <div class="card border-0 text-center align-items-center justify-content-center">
                            <img src="./assets/images/mortgage-icon.svg" alt="Mortgage Refinance Eligibility" data-aos="zoom-in" data-aos-delay="600"  />
                            <div class="card-body p-0 mt-lg-4">
                ...
                <div class="row">
                        ...
                        <div class="card border-0">
                            <div class="card-thumb">
                                <div class="thumb-first z-1 position-absolute">
                                    <img src="./assets/images/tailored-financial.png" alt="Tailored Financial Solutions" data-aos="fade-up" data-aos-delay="200"/>
                                </div>
                                <div class="thumb-second">
                                    <img src="./assets/images/shape-tailored-financial.png" alt="Tailored Financial Solutions" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="5000" />
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 icon-container">
                        <div class="card border-0">
                            <div class="card-thumb">
                                <div class="thumb-first z-1 position-absolute">
                                    <img src="./assets/images/full-spectrum.png" alt="Full-Spectrum Convenience" data-aos="fade-up" data-aos-delay="400" />
                                </div>
                                <div class="thumb-second">
                                    <img src="./assets/images/shape-fullspectrum.png" alt="Full-Spectrum Convenience" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="5000"/>
                                </div>
                            </div>
                            <div class="card-body p-0">
                    ...
                    <div class="col-md-3 icon-container">
                        <div class="card border-0">
                            <div class="card-thumb">
                                <div class="thumb-first z-1 position-absolute">
                                    <img src="./assets/images/transparent-trustworthy.png" alt="Full-Spectrum Convenience" data-aos="fade-up" data-aos-delay="600" />
                                </div>
                                <div class="thumb-second">
                                    <img src="./assets/images/shape-transparent-trustworthy.png" alt="Full-Spectrum Convenience" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="5000"/>
                                </div>
                            </div>
                            <div class="card-body p-0">
                    ...
                    <div class="col-md-3 icon-container">
                        <div class="card border-0">
                            <div class="card-thumb">
                                <div class="thumb-first z-1 position-absolute">
                                    <img src="./assets/images/Completely-free-service.png" alt="Completely Free Service" data-aos="fade-up" data-aos-delay="800"/>
                                </div>
                                <div class="thumb-second">
                                    <img src="./assets/images/shape-completely-free-service.png" alt="Completely Free Service" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="5000" />
                                </div>
                            </div>
                            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 card-container">
                        <div class="card border-0 align-items-start">
                            <img src="./assets/images/FINTOSAdvice-logo-1.png" height="55px" alt="fintos advice" data-aos="zoom-in" />
                            <div class="card-body p-0 d-flex flex-column">
                            <h5 class="card-title">Navigation Better <br/>Financial Moves</h5>
                            <ul class="card-text list-unstyled text-start">
                                <li class="d-flex flex-row gap-1 align-items-center"><img src="./assets/images/check-circle.png" alt="check" />Mortgage Solution</li>
                                <li class="d-flex flex-row gap-1 align-items-center"><img src="./assets/images/check-circle.png" alt="check" />Debt Restructuring Program</li>
                                <li class="d-flex flex-row gap-1 align-items-center"><img src="./assets/images/check-circle.png" alt="check" />Property Investment</li>
                            </ul>
                    ...
                    <div class="col-md-4 card-container">
                        <div class="card border-0 align-items-start">
                            <img src="./assets/images/FINTOSCapital-logo-1.png" alt="fintos capital" height="55px" data-aos="zoom-in" data-aos-delay="200"  />
                            <div class="card-body p-0 d-flex flex-column">
                            <h5 class="card-title">Ace All of Life's <br/>Financial Needs</h5>
                            <ul class="card-text list-unstyled text-start">
                                <li class="d-flex flex-row gap-1 align-items-center"><img src="./assets/images/check-circle.png" alt="check" />Mortgage Refinance</li>
                                <li class="d-flex flex-row gap-1 align-items-center"><img src="./assets/images/check-circle.png" alt="check" />Property Financing </li>
                                <li class="d-flex flex-row gap-1 align-items-center"><img src="./assets/images/check-circle.png" alt="check" />Debt Consolidation</li>
                            </ul>
                    ...
                    <div class="col-md-4 card-container">
                        <div class="card border-0 align-items-start">
                            <img src="./assets/images/FINTOSTech-logo-1.png" alt="fintos tech"  height="55px" data-aos="zoom-in" data-aos-delay="400"  />
                            <div class="card-body p-0 d-flex flex-column">
                            <h5 class="card-title">Better Decisions.<br/>Better Insights.</h5>
                            <ul class="card-text list-unstyled text-start">
                                <li class="d-flex flex-row gap-1 align-items-center"><img src="./assets/images/check-circle.png" alt="check" />Mortgage Solution System</li>
                                <li class="d-flex flex-row gap-1 align-items-center"><img src="./assets/images/check-circle.png" alt="check" />Lending Management System</li>
                                <li class="d-flex flex-row gap-1 align-items-center"><img src="./assets/images/check-circle.png" alt="check" />Agent Commission Software</li>
                            </ul>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-6 video-fn">
                        <div class="tagline text-start align-items-start d-flex flex-column">
                            ...
                            <img src="./assets/images/fintoslogo-highres.png" alt="google" />
                            ...
                            <div class="award">
                                <ul class="list-unstyled d-flex flex-row award-container">
                                    <li><img class="img-fluid" src="./assets/images/award1.png" alt="award"/></li>
                                    <li><img class="img-fluid" src="./assets/images/award2.png" alt="award"/></li>
                                    <li><img class="img-fluid" src="./assets/images/award3.png" alt="award"/></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-lg-6">
                        <div class="videowrap position-relative">
                            ...
                            <img src="./assets/images/MP7.jpg" alt="video" />
                        </div>
                    </div>
                </div>
                <div class="row mt-5 gallery-fin">
                    <div class="col-md-4 img-container"><img src="./assets/images/home-img-1.jpg" alt="thumbnail" /></div>
                    <div class="col-md-4 img-container"><img src="./assets/images/home-img-2.jpg" alt="thumbnail" /></div>
                    <div class="col-md-4 img-container"><img src="./assets/images/home-img-3.jpg" alt="thumbnail" /></div>
                </div>
            </div>
        </div><!--[end:aboutus]-->
            ...
            <div class="container">
                <div class="row bglightyellow">
                    <div class="col-md-5 img-ct">
                        <div class="thumb-cta">
                            <img src="./assets/images/thumb-cta.png" alt="thumbnail" class="img-fluid"/>
                        </div>
                    </div>
                    <div class="col-md-7">
