...
<body>
    <cms:editable name='career-detail-group-operations-manager' label='Career Detail Page' type='richtext'>
        <div class="site-header bgwhite d-flex align-items-center"><!--[start: site-header]-->
            <div class="container">
                <div class="row">
                    <nav class="navbar navbar-expand-lg">
                        <div class="container-fluid justify-content-between">
                        <a class="navbar-brand" href="index.php"><img src="https://fintos.com.my/newfintos_cms/assets/images/fintos-logo-dark.png" alt="app" class="img-fluid"  /></a>
                                        ...
                                        <div class="d-flex py-3 px-4 mx-1 flex-col flex-lg-row gap-4 flex-column flex-md-row">
                                            <div class="col">
                                                ...
                                                <div class="card card--nav border-0">
                                                    <div class="card-head mb-3">
                                                        <img src="https://fintos.com.my/newfintos_cms/assets/images/fintos-advice-logo-nav.svg" alt="fintos advice" class="img-fluid"  />
                                            ...
                                            <div class="col">
                                                <a href="fintos-capital.php" class="fw-semibold">
                                                    <div class="card card--nav border-0">
                                                        <div class="card-head mb-3">
                                                            <img src="https://fintos.com.my/newfintos_cms/assets/images/fintos-finance-logo-nav.svg" alt="Fintos Capital" class="img-fluid"  />
                                            ...
                                            <div class="col">
                                                <a href="fintos-tech-a.php" class="fw-semibold">
                                                    <div class="card card--nav border-0">
                                                        <div class="card-head mb-3">
                                                            <img src="https://fintos.com.my/newfintos_cms/assets/images/fintos-tech-logo-nav.svg" alt="fintos tech" class="img-fluid"  />
                                                            <p class="my-2">Make smart choices with your finances</p>
                                                            <div class="more fw-semibold">Learn More <img src="https://fintos.com.my/newfintos_cms/assets/images/arrow-right.svg" alt="fintos advice" class="img-fluid ps-1"  /></div>
                                                        </div>
                ...
                <div class="col-lg-8 pe-4">
                    <div class="entry-content me-sm-0 me-lg-5 pe-sm-0">
                        <div class="back-career">
                            <img src="https://fintos.com.my/newfintos_cms/assets/images/arrow-left.png" alt="app" class="img-fluid me-1" />
                            <a href="career.php">Back</a>
                        </div>
                        <h2 class="heading-single fw-semibold mt-4 pt-2 mb-4 pb-3">Group Operation Manager</h2>
                        ...
                        <p>We are seeking an experienced and detail-oriented Group Operation Manager to join our dynamic team. This role requires a blend of technical expertise in finance and accounting, strong leadership abilities, and excellent communication skills. The successful candidate will play a pivotal role in shaping our financial strategy and ensuring effective financial management across the company.
                        </p>
                        <br/>
                        <p class="mb-2"><b>Key Responsibilities</b></p>
                        <ul>
                            <li>Oversee daily operations across various departments, ensuring smooth and efficient processes.</li>
                            <li>Ensure the smooth execution of the sales process and overall business operations.</li>
                            <li>Monitor and optimize the entire operational workflow to achieve maximum efficiency and productivity.</li>
                            <li>Develop and implement operational policies, procedures, and best practices to optimize performance and ensure compliance with relevant regulations.</li>
                            <li>Continuously update and refine SOPs to align with industry standards and organizational needs.</li>
                            <li>Collaborate with senior management to develop and execute long-term strategic plans and initiatives.</li>
                            <li>Drive the adoption of technology and digital solutions to enhance operational efficiency and support business objectives.</li>
                            <li>Analyze KPIs and financial data to identify trends, areas for improvement, and opportunities for growth.</li>
                            <li>Prepare and submit regular sales and OKR performance reports to top management, highlighting key achievements and areas for improvement.</li>
                            <li>Provide insights and recommendations for enhancing the company's sales performance and overall growth.</li>
                            <li>Maintain strong relationships with industry stakeholders, including clients, partners, and regulators, to expand business opportunities and ensure client satisfaction.</li>
                            <li>Ensure all operations adhere to applicable laws, regulations, and industry standards.</li>
                            <li>Stay well-versed with legal and regulatory changes to ensure ongoing compliance.</li>
                            <li>Collaborate with other departments, such as sales, marketing, and finance, to achieve organizational goals and support overall business growth.</li>
                            <li>Monitor the operation team's efforts to keep the company's systems updated and aligned with industry best practices.</li>
                            <li>Develop and maintain a high-performing customer service team.</li>
                            <li>Implement performance management strategies to ensure the customer service team consistently meets and exceeds expectations.</li>
                            <li>Provide regular feedback, coaching, and training to improve team members' skills and foster a culture of continuous improvement.</li>
                        </ul>
                        <br/>
                        <p class="mb-2"><b>Qualifications</b></p>
                        <ul>
                            <li>At least 5 years of experience in an operational managerial position within a bank.</li>
                            <li>Proven experience in drafting and implementing SOPs.</li>
                            <li>Bachelor’s degree in business administration; MBA preferred.</li>
                            <li>Familiarity with laws, regulations, and compliance standards in the banking industry.</li>
                            <li>Strong analytical skills with the ability to interpret complex data and provide actionable insights.</li>
                            <li>Excellent communication and interpersonal skills.</li>
                            <li>Ability to speak Mandarin is essential due to the business nature.</li>
                            <li>Proficiency in relevant digital tools and technology to support operational efficiency.</li>
                        </ul>
                        ...
                        <ul class="d-flex mb-5 pb-3 gap-3 flex-wrap list-unstyled">
                            <li class="badge rounded-pill text-bg-lightgray">Operational Oversight</li>
                            <li class="badge rounded-pill text-bg-lightgray">Strategic Planning</li>
                            <li class="badge rounded-pill text-bg-lightgray">Performance Analysis</li>
                            <li class="badge rounded-pill text-bg-lightgray">Stakeholder Management</li>
                            <li class="badge rounded-pill text-bg-lightgray">Customer Service Team Development</li>
                        </ul>
                    ...
                    <div class="sidebar bglightyellow p-4 rounded-4">
                        ...
                        <ul class="list-unstyled d-flex flex-column gy-4">
                            ...
                            <li class="mb-3 pb-1">
                                ...
                                <div class="entry">Operations</div>
                            </li>
                            <li class="mb-3 pb-1">
                                <div class="title mb-1">Experience Level</div>
                                <div class="entry">5 Years of Experience</div>
                            </li>
                            <li class="mb-3 pb-1">
